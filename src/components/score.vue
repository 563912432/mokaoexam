      ...
      <div class="header2">
        <div class="subject">
          <div v-for="(paper, index) in currentExam.paper" :key="index" style="flex:1;display: flex">
            <div v-if="parseInt(paper.course_id) === course.kuaijishiwu" class="btn-div"><div class="btn1" @click="tabChange('0', paper.id)"></div></div>
            <div v-if="parseInt(paper.course_id) === course.jingjifa" class="btn-div"><div class="btn2" @click="tabChange('1', paper.id)"></div></div>
            <div v-if="parseInt(paper.course_id) === course.caiwuguanli" class="btn-div"><div class="btn3" @click="tabChange('2', paper.id)"></div></div>
          </div>
        </div>
      </div>
...
<style scoped>
  ...
  .btn1 {
    ...
    width: 180px;
    height: 48px;
    background: url("../assets/btn3.png") no-repeat center;
    cursor: pointer;
    border-radius: 25px;
  }
  .btn2 {
  ...
  .score1-header {
    ...
    height: 42px;
    margin: 0 auto;
    background: url("../assets/text1.png") no-repeat center;
  }
  .score1-header1 {
    width: 340px;
    height: 42px;
    margin: 0 auto;
    background: url("../assets/text2.png") no-repeat center;
  }
  .score1-header2 {
    width: 340px;
    height: 42px;
    margin: 0 auto;
    background: url("../assets/text3.png") no-repeat center;
  }
  .score1-content{
    margin-top: 60px;
