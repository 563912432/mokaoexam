            ...
            <div class="card-item">
              ...
              <div class="card-item-line1">
                <div v-for="(paper, index) in item.paper" :key="index" style="margin-right: 10px">
                  <el-button v-if="parseInt(paper.course_id) === course.chujishiwu" type="danger"
                             @click="textParse(paper.id)">初级会计实务文字解析
                  </el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.jingjifajichu" type="danger"
                             @click="textParse(paper.id)">经济法基础文字解析
                  </el-button>
                </div>
              </div>
              <div class="card-item-line2">
                <div v-for="(paper, index) in item.paper" :key="index" style="margin-right: 10px">
                  <el-button v-if="parseInt(paper.course_id) === course.chujishiwu" type="danger" class="pule"
                             @click="videoHistory">初级会计实务视频解析
                  </el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.jingjifajichu" type="danger" class="pule"
                             @click="videoHistory">经济法基础视频解析
                  </el-button>
                </div>
              </div>
            </div>
...
<style scoped>
  ...
  .index5-header {
    ...
    z-index: 1;
    position: relative;
    background: #3c2166 url('../assets/index5_header_chuji.png') no-repeat center;
  }
  ...
  .index5-bottom1 {
    ...
    margin-left: 160px;
    margin-right: 160px;
    background: #3c2166 url('../assets/index5_bottom1_chuji.png') no-repeat center;
    z-index: 1;
    position: relative;
  }
  ...
  .index5-bottom2 {
    ...
    height: 519px;
    margin-right: 160px;
    background: #3c2166 url('../assets/index5_bottom2_jingjifa.png') no-repeat center;
    z-index: 1;
    position: relative;
  }
