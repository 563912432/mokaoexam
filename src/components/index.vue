          ...
          <div v-if="parseInt(paper.course_id) === parseInt(course.jingjifa)" class="index5-bottom2">
            ...
            <div class="index5-div flex flex-column flex-align-center flex-justify-center">
              ...
              <div v-else-if="!currentExam.running" class="text-center">
                ...
                <div class="margin-top-10">
                  <el-button type="warning" round class="button purple" @click="watchScore(paper.id, 1)">查看排名</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button type="primary" round class="button blue" @click="textParse(paper.id)">查看文字解析</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button type="primary" round class="button darkGreen" @click="videoParse(currentExam.liveroom)">查看视频解析</el-button>
                </div>
              </div>
              <div v-else class="text-center">
                <div class="margin-top-10">
                  <el-button v-if="!paper.done" type="success" round class="button green" @click="toExam(paper.id)">进入考试</el-button>
                </div>
                <div>
                  <el-button v-if="!!paper.done" type="success" disabled round class="button green">已完成</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button v-if="!!paper.done" type="warning" round class="button purple" @click="watchScore(paper.id, 1)">查看排名</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button v-if="!!paper.done" type="primary" round class="button blue" @click="textParse(paper.id)">查看文字解析</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button v-if="!!paper.done" type="primary" round class="button darkGreen" @click="videoParse(currentExam.liveroom)">查看视频解析</el-button>
                </div>
              </div>
            </div>
          </div>
          <div v-if="parseInt(paper.course_id) === parseInt(course.caiwuguanli)" class="index5-bottom3">
            ...
            <div class="index5-div flex flex-column flex-align-center flex-justify-center">
              ...
              <div v-else-if="!currentExam.running" class="text-center">
                ...
                <div class="margin-top-10">
                  <el-button type="warning" round class="button purple" @click="watchScore(paper.id, 2)">查看排名</el-button>
                </div>
                <div class="margin-top-10">
              ...
              <div v-else class="text-center">
                ...
                <div class="margin-top-10">
                  <el-button v-if="!!paper.done" type="warning" round class="button purple" @click="watchScore(paper.id, 2)">查看排名</el-button>
                </div>
                <div class="margin-top-10">
                  <el-button v-if="!!paper.done" type="primary" round class="button blue" @click="textParse(paper.id)">查看文字解析</el-button>
                </div>
            ...
            <div class="card-item">
              ...
              <div class="card-item-line1">
                <div v-for="(paper, index) in item.paper" :key="index" style="margin-right: 10px">
                  <el-button v-if="parseInt(paper.course_id) === course.kuaijishiwu" type="danger" @click="textParse(paper.id)">会计实务文字解析</el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.jingjifa" type="danger" @click="textParse(paper.id)">经济法文字解析</el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.caiwuguanli" type="danger" @click="textParse(paper.id)">财务管理文字解析</el-button>
                </div>
              </div>
              <div class="card-item-line2">
                <div v-for="(paper, index) in item.paper" :key="index" style="margin-right: 10px">
                  <el-button v-if="parseInt(paper.course_id) === course.kuaijishiwu" type="danger" class="pule" @click="videoHistory">会计实务视频解析</el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.jingjifa" type="danger" class="pule" @click="videoHistory">经济法视频解析</el-button>
                  <el-button v-if="parseInt(paper.course_id) === course.caiwuguanli" type="danger" class="pule" @click="videoHistory">财务管理视频解析</el-button>
                </div>
              </div>
            </div>
          </el-carousel-item>
